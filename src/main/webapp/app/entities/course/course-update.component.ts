...
export class CourseUpdateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.questionBankService
      ...
      .subscribe(
        (res: IQuestionBank[]) => {
          if (!this.editForm.get('questionBank').value || !this.editForm.get('questionBank').value.id) {
            this.questionbanks = res;
          } else {
            this.questionBankService
              .find(this.editForm.get('questionBank').value.id)
              .pipe(
  ...
  private createFromForm(): ICourse {
    return {
      ...
      questionBank: this.editForm.get(['questionBank']).value,
